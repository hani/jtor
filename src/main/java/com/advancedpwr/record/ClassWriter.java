...
public abstract class ClassWriter
{
	 ...
	 * @param inName The fully qualified class name
	 */
    ...
    write("@Generated(value=\"" + getClass().getName() + "\", date=\"" + format.format(System.currentTimeMillis()) + "\", comments=\"Generated by " + System.getProperty("user.name")+ "\")");
